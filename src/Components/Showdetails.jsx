...
export const Showdetails = () => {
  ...
  return (
    ...
    >
      <motion.div
        className={`relative bg-gradient-to-br ${colors.primary} ${colors.secondary} lg:p-8 p-2 rounded-3xl shadow-2xl text-white w-full h-[83%] md:h-[89%] max-w-md border border-white/10 overflow-hidden`}
